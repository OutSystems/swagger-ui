...
this["Handlebars"]["templates"]["main"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += "</div>\n<div class='container' id='resources_container'>\n  <ul id='resources'></ul>\n\n  <div class=\"footer\">\n    <br>\n    <br>\n    <h4 style=\"color: #999; margin-bottom: 25px;\">[ <span style=\"font-variant: small-caps\">base url</span>: "
    ...
    + "\n    <!-- OutSystems change: remove version number and increase bottom margin\n";
...
this["Handlebars"]["templates"]["operation"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += "					<!-- OutSystems change: position of the response -->\r\n";
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.type : depth0), {"name":"if","hash":{},"fn":this.program(20, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer + "					<!-- OutSystems change: removed Try it out button -->\r\n						</form>\r\n						<div class='response' style='display:none'>\r\n							<h4>Request URL</h4>\r\n							<div class='block request_url'></div>\r\n							<h4>Response Body</h4>\r\n							<div class='block response_body'></div>\r\n							<h4>Response Code</h4>\r\n							<div class='block response_code'></div>\r\n							<h4>Response Headers</h4>\r\n							<div class='block response_headers'></div>\r\n						</div>\r\n					</div>\r\n					</li>\r\n				</ul>\r\n";
},"useData":true});
var ContentTypeView,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
OperationView = (function(superClass) {
  ...
  OperationView.prototype.render = function() {
    ...
    if (typeof this.model.responses !== 'undefined') {
      ...
      for (code in ref2) {
        ...
        if (schemaObj && schemaObj['$ref']) {
          ...
          if (!this.model.responses[code].schema) {
            nonObjectSchema = {
    ...
    if (signatureModel) {
      ...
      if (this.model.type !== null) {
        if (this.model.produces !== null && this.model.produces.length === 1 && (this.model.produces[0] = "application/octet-stream")) {
          $('.model-signature', $(this.el)).html("binary");
        } else {
          $('.model-signature', $(this.el)).html(this.model.type.schema.type);
        }
      } else {
        $('.model-signature', $(this.el)).html("nothing");
      }
    }
    contentTypeModel = {
      isParam: false
    ...
    $(".request_url", $(this.el)).html('<pre style="overflow-y:auto"></pre>');
    $(".request_url pre", $(this.el)).text(this.model.getRequestUrl());
    return this;
  };
  ...
  OperationView.prototype.addStatusCode = function(statusCode) {
    var responseContentTypeView, statusCodeView;
    ...
    return $('.content-type', this.$el).append(responseContentTypeView.render().el);
  };
...
this["Handlebars"]["templates"]["response_content_type"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  var stack1, lambda=this.lambda, escapeExpression=this.escapeExpression, buffer = "<!--OutSystems change: removed label, pre and fixed ";
  stack1 = lambda(depth0, depth0);
  if (stack1 != null) { buffer += stack1; }
  buffer += " to "
...
ParameterView = (function(superClass) {
  ...
  ParameterView.prototype.render = function() {
    ...
    if (((!this.model.consumes) || (this.model.consumes && this.model.consumes.length === 0)) && this.model.signature === "string" && this.model["in"] === "body") {
      this.model.type = this.model.signature = "binary";
    } else {
    ...
    template = this.template();
    $(this.el).html(template(this.model));
    if (this.model["in"] !== "body") {
      this.model.sampleJSON = (new Property("xpto", this.model, false)).getSampleValue({}, {});
    } else if (!this.model.sampleJSON && this.model.schema) {
