...
SwaggerUi.Views.OperationView = Backbone.View.extend({
    ...
    if (typeof this.model.responses !== 'undefined') {
      ...
      for (code in ref2) {
        ...
        this.model.responseMessages.push({
          ...
          responseModel: this.model.responses[code].resolvedModel,
					sampleJSON: (this.model.responses[code].sampleJSON || null),
					signature: (this.model.responses[code].signature || null)
        });
      }
    }
  ...
  addStatusCode: function(statusCode) {
    ...
    responseContentTypeView = new SwaggerUi.Views.ResponseContentTypeView({model: this.model, tagName: 'div'})
		// OutSystems change: Response Content Type is now displayed in Response Messages
    $('.content-type', $(this.el)).append(responseContentTypeView.render().el);
  },
  ...
  switchToDescriptionParameter: function(e){
    if (e) { e.preventDefault(); }
    ...
    $('.snippet-link', $('.parameter-table', this.el)).removeClass('selected');
  },

  // handler for show sample
  switchToSnippetParameter: function(e){
    if (e) { e.preventDefault(); }
    ...
    $('.description-link', $('.parameter-table', this.el)).removeClass('selected');
  },
	
	// handler for show signature
	switchToDescriptionResponse: function(e){
    if (e) { e.preventDefault(); }
    ...
    $('.snippet-link', $('.response-table', this.el)).removeClass('selected');
  },

  // handler for show sample
	switchToSnippetResponse: function(e){
    if (e) { e.preventDefault(); }
    ...
    $('.snippet-link', $('.response-table', this.el)).addClass('selected');
		$('.description-link', $('.response-table', this.el)).removeClass('selected');
	},
});
